...
const Privacy = () => {
  return (
    <Fragment>
      <NavBar />
      <div className="mx-4 md:mx-8 lg:mx-12 xl:w-2/3 xl:mx-auto ">
        <p className="pt-2 font-bold text-5xl">Política de Privacidad</p>
        <p className="leading-relaxed text-2xl font-semibold text-gray-600 pt-8">
          Platjadepalma te informa sobre su Política de Privacidad respecto del
          ...
          contratación de servicios a través del sitio Web Platjadepalma.com.
        </p>
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Titular: Platjadepalma
        </p>

        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">NIF/CIF: </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Domicilio: 07600
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Correo electrónico: info@platjadepalma.com
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Sitio Web: Platjadepalma.com
        </p>
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">- Facebook</p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">- Twitter</p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">- Instagram</p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Al navegar por Platjadepalma.com se pueden recoger datos no
        ...
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
          Para ejercitar tus derechos de acceso, rectificación, cancelación,
          portabilidad y oposición tienes que enviar un correo electrónico a
          info@platjadepalma.com junto con la prueba válida en derecho como una
          fotocopia del D.N.I. o equivalente.
        </p>
        <p className="pt-2 font-normal text-gray-500 text-sm leading-relaxed">
