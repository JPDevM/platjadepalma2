    ...
    <Fragment>
      ...
      <div className="mx-4 md:mx-8 lg:mx-12  xl:w-2/3 xl:mx-auto">
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          ...
          nuestros productos. platjadepalma no asume la responsabilidad en caso
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          PlatjaDePalma a través de su sitio web concede una licencia para que
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          Este platjadepalma garantiza que la información personal que usted
        ...
        <p className="leading-relaxed text-base text-justify text-gray-500 font-normal pt-2">
          PlatjaDePalma reserva los derechos de cambiar o de modificar estos
