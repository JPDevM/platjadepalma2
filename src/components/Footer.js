...
const Footer = () => {
  return (
    <Fragment>
      <div className="w-full xl:px-20 lg:px-12 sm:px-6 px-4 py-12 bg-gray-100 mt-24">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex items-center gap-x-8 mt-6">
            <div className="cursor-pointer">
              ...
              <a
                href={
                  'https://www.facebook.com/pages/Platja-de-Palma/153582844679694'
                }
                target={'_blank'}
            ...
            <div className="cursor-pointer">
              ...
              <a
                href={
                  'https://www.instagram.com/explore/tags/platjadepalma/?hl=es'
                }
                target={'_blank'}
                rel={'noopener noreferrer'}
              >
          ...
          <div className="flex items-center mt-6">
            ...
            <div className="border-l h-6 border-gray-800 px-1 w-1/10"></div>
            <p className="text-base leading-4 text-gray-800 w-1/2">
